...
public class AccountAPI {
	...
	public Account getAccountByNumber(@PathVariable("accountNumber") String accountNumber) throws AccountNotFoundException{
	...
	public Account getAccountByEmail (@PathVariable("email") String email) throws EmailNotFoundException{
