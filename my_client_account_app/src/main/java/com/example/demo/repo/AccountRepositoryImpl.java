...
public class AccountRepositoryImpl implements AccountRepository {
	...
	@Override
	public Account getAccountByemail(String email) throws EmailNotFoundException {
		// TODO Auto-generated method stub
		Session session = sessionFactory.openSession();
		TypedQuery<Account> query = session.createQuery("FROM Account A where A.email=:e",Account.class);
